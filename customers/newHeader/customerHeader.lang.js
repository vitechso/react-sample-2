...
export default {
  ...
  licenseOverview: genOpts('licenseOverview', 'License Overview'),
  totalCustomers: genOpts('totalCustomers', 'Total Companies'),
  monthlyActiveUsers: genOpts('monthlyActiveUsers', 'Monthly Active Users'),
  totalLicenses: genOpts('totalLicenses', 'Total Licenses'),
  totalUniquePlans: genOpts('totalUniquePlans', 'Total Unique Plans'),
  microsoftHelper: genOpts('microsoftHelper', 'Automate the Import of your customers'),
  microsoftLogoHelper: genOpts('microsoftLogoHelper', 'Partner Center'),
  azureHelper: genOpts('azureHelper', 'Connect resources to your companies.'),
  salesforceHelper: genOpts('salesforceHelper', 'Coming Soon!')
};
